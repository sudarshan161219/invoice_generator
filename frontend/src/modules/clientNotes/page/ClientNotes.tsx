...
//   const handleDeleteFile = (noteId: number) => {
//     warning();
//     setOpenPopoverId(null);
//   };
...
//                 setMobileDetail(note); // mobile → open modal
//               } else {
//                 setActiveNote(note); // desktop → set in right panel
//               }
//             };
...
//                     ? "bg-[var(--card)] ring-2 ring-blue-400"
//                     : "hover:bg-[var(--card)]"
//                 }`}
//               >
...
//                         <li
//                           className="flex items-center gap-2 p-1 hover:bg-gray-100 rounded cursor-pointer"
//                           onClick={(e) => handleDeleteFile(note.id)}
//                         >
...
//         {/* Active note detail (desktop only) */}
//         <div className="col-span-2 border rounded-lg p-4 overflow-y-auto hidden md:block">
//           {activeNote ? (
//             <>
...
//                   style={{ color: activeNote.label?.color }}
//                 >
//                   <Dot size={16} />
//                   {activeNote.label?.name}
//                 </span>
...
//       {/* Mobile modal for note detail */}
//       {mobileDetail && (
//         <div
//           className="fixed inset-0 z-50 bg-black/50 flex justify-center items-center"
//           onClick={() => setMobileDetail(null)}
//         >
//           <div className="bg-[var(--card)] rounded-lg w-11/12 max-w-md relative flex flex-col max-h-[90vh]">
//             {/* Close button */}
//             <button
